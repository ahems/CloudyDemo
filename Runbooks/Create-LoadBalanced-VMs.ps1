 ...
 $CredentialAsset = Get-AutomationPSCredential -Name 'CloudyDemosCredential' -ErrorAction Stop
 ...
 Login-AzureRmAccount -Credential $CredentialAsset -SubscriptionId $subscriptionId -ErrorAction Stop
